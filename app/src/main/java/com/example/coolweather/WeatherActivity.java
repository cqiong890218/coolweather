...
public class WeatherActivity extends AppCompatActivity {
    ...
    private TextView degreeText;//显示当前气温
    private TextView weatherInfoText;//显示天气概况
    private LinearLayout forecastLayout;//显示未来几天天气信息
    ...
    private TextView sportText;//显示运动指数
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(weatherString != null) {
            ...
            mWeatherId = weather.basic.weaterId;
    ...
    private void initViews() {
        ...
        swipeFresh = (SwipeRefreshLayout)findViewById(R.id.swipe_fresh);
        swipeFresh.setColorSchemeResources(R.color.colorPrimary);
